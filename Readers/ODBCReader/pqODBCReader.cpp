...
//________________________________________________________________________
void pqODBCReader::linkServerManagerProperties()
{
...
//________________________________________________________________________
void pqODBCReader::onTableSelectionChanged(int index)
{
	...
	{
		QTableWidget* activeWidget = this->propTableWidgets[activeTable];
		...
		this->propDW->setWidget(activeWidget);
	}
	else
	{
...
//________________________________________________________________________
void pqODBCReader::onTableTypeSelectionChanged(int index)
{
	if(this->cb_tables->count() == 0)
		return;
...
//________________________________________________________________________
void pqODBCReader::updatePyPzIndexes(int index)
{
...
//________________________________________________________________________
void pqODBCReader::onTableItemSelectionChanged( QTableWidgetItem* item)
{
	int row = item->row();
...
//________________________________________________________________________
void pqODBCReader::restoreGuiState()
{
	QString text;
...
//________________________________________________________________________
void pqODBCReader::setComboBoxIndex(QComboBox* comboBox, QString &text)
{
